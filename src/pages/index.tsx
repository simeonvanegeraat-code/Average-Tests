...
export default function Home() {
  return (
    <Layout title="Find out how average you are" description="Quick, modern tests that compare you to the average — money, screen time, focus and more.">
      <section className="mb-8">
        <h2 className="text-3xl font-bold mb-2">Find out how average you really are</h2>
        <p className="text-gray-700 dark:text-gray-300">
          Short, no-nonsense tests. We compare your input to the average and give you clear tips.
        </p>
      </section>
